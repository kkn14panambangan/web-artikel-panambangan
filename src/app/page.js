  ...
  return (
    <div className="fade-in">
      <div className="hero" style={{ position: 'relative', height: 'min(600px, 80vh)', backgroundColor: '#000', borderRadius: '32px', overflow: 'hidden', marginBottom: '80px', display: 'flex', alignItems: 'center', padding: '0 8%', boxShadow: '0 30px 60px rgba(0,0,0,0.12)' }}>
        ...
        <div className="hero-content" style={{ position: 'relative', zIndex: 10, color: 'white', maxWidth: '1000px', width: '100%' }}>
          ...
          <p style={{ maxWidth: '750px', fontSize: 'clamp(15px, 1.8vw, 18px)', lineHeight: 1.6, opacity: 0.9, textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>
